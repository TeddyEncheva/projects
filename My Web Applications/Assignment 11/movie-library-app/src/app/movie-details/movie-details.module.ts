...
import { CastMemberComponent } from '../full-cast/components/cast-member/cast-member.component';
...
@NgModule({
  ...
  exports: [CastMemberComponent, TopCastComponent, TopReviewsComponent],
