...
export class MovieRecommendationsComponent implements OnInit{
    ...
    constructor(private detailsService: MovieDetailsService, private route:ActivatedRoute){
    }
    ...
    private getMovieList(): void{
        this.detailsService.getRecommended(this.id).subscribe(data =>  this.movies = data);
    }
